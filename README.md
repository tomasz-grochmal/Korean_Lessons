...
Otwórz plik `index.html` w przeglądarce. Aplikacja działa bez instalowania zależności i bez internetu.
...
Wymowa jest uproszczona pod polskiego użytkownika. Ma pomóc szybko mówić pierwsze zwroty, ale nie zastępuje osłuchania się z prawdziwym koreańskim.
